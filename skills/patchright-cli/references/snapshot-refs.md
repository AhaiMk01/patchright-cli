...
subtree with a breadcrumb. Across 13 queries on four real pages, total output
was 13KB here against 37KB there (a single lookup is a few hundred bytes). `--all` widens the search to every node like
